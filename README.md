...
42. tree based model - 決策樹程式碼撰寫 使用 Scikit-learn 撰寫決策樹 (Decision Tree) 模型的程式碼
    * [文件及範例](https://github.com/ChengCheHiseh/ML100Days/tree/master/homework/Day_042_Document)
...
44. tree based model - 隨機森林程式碼撰寫 使用 Scikit-learn 撰寫隨機森林 (Random Forest) 模型的程式碼
    * [文件及範例](https://github.com/ChengCheHiseh/ML100Days/tree/master/homework/Day_044_Document)
